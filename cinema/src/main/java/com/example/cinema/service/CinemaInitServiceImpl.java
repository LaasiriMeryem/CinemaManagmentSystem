...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initCinemas() {
		villeRepository.findAll().forEach(v->{
			Stream.of("Megarama","IMAX","FOUNOUN","CHAHRAZAD","RENAISSANCE")
			.forEach(nameCinema->{
	...
	public void initCategories() {
		...
		Stream.of("Histoire","Actions","Drama","Fiction")
		.forEach(c->{
	...
	public void initFilms() {
		...
		Stream.of("Cat Women","Valhala","Taxi driver","Banshee","Mouse")
		.forEach(titre->{
			Film film=new Film();
			film.setTitre(titre);
	...
	public void initProjections() {
		double[] prices=new double[] {30,50,60,70,80,100};
